...
bindir="/global/homes/h/hross/codes/WRF1996/run/"
binname="ideal.exe"
binname2="wrf.exe"
#binname="tc.exe"
rundir="/pscratch/sd/h/hross/simulation/WRF/seabreeze" #user needs to change this
...
#get ics
srun -n 1 -c 1 --cpu_bind=cores ${bindir}/${binname}
...
srun -n 1 -c 1 --cpu_bind=cores ${bindir}/${binname2}
